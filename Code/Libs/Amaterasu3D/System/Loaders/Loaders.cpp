...
void Loaders::RegisterAllLoaders()
{
	...
	CMediaManager::Instance().RegisterLoader<Texture>(new ImagesLoader,
			"bmp, dds, exr, gif, hdr, jpg, pcx, png, pnm, raw, sgi, tga, tif");
	CMediaManager::Instance().RegisterLoader<Shader>(new ShadersLoader,
			"shader");
