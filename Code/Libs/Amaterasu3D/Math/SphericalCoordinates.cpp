...
/** \brief Changement du vecteur represente en coordonnees spheriques */
void SphericalCoordinates::Set( glm::vec3 const & v)
{
...
/** \brief Recuperation du vecteur q partir des coordonnees spheriques */
 glm::vec3 SphericalCoordinates::Get() const
{
	return  glm::vec3(m_module * sin(m_phy) * cos(m_theta),
...
SphericalCoordinates::SphericalCoordinates( glm::vec3 const & v)
{
	Set(v);
}
