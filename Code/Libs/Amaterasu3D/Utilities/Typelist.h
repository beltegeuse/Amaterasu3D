...
////////////////////////////////////////////////////////////
// Macros servant e construire des typelists
////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////
// Quelques operations utiles sur les typelists
////////////////////////////////////////////////////////////

////////////////////////////////////////////////////////////
/// Recherche le N-ieme element d'une typelist
////////////////////////////////////////////////////////////
template<std::size_t N, class List> struct NthElement;

////////////////////////////////////////////////////////////
/// Determine de la taille d'une typelist
////////////////////////////////////////////////////////////
template<class List> struct Size;

////////////////////////////////////////////////////////////
/// Recherche la position d'un element dans une typelist
////////////////////////////////////////////////////////////
template<class ToFind, class List> struct Find;

////////////////////////////////////////////////////////////
/// Ajoute un element e la fin d'une typelist
////////////////////////////////////////////////////////////
template<class T, class List> struct PushBack;

////////////////////////////////////////////////////////////
/// Ajoute d'un element au debut d'une typelist
////////////////////////////////////////////////////////////
template<class T, class List> struct PushFront;

////////////////////////////////////////////////////////////
/// Concatene 2 typelists
////////////////////////////////////////////////////////////
